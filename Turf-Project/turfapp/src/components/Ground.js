  ...
  return ( 
    ...
    <div className='container' >
      ...
      <div className='row' >
        ...
        <h1 className='h1  text-center' ><u>Add Ground</u></h1>
          <form className="row g-3 pt-3 pb-5" >
            ...
            <div className="col-md-6">
              ...
              <input type="text" className="form-control" id="GroundLength" placeholder="Enter the Ground Length" />
            </div>
            ...
            <div className="col-md-6">
              ...
              <input type="number" className="form-control" id="GroundLength" placeholder="Enter the Price" />
            </div>
            ...
            <div className="col-12">
              <button type="submit" className="btn btn-primary" style={{width: "calc(100% )"}} >
                Sign in
              </button>
            </div>
          </form>
